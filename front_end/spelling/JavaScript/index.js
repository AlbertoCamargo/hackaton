...
image.src = src;
var animations = new animation(image, 254, 242);
startAnimating(6, 'canvas');
var stop, context;
function startAnimating(fps, id_canvas) {
    ...
    return $letters.on("mousedown", function(e) {
      ...
      dropIntoSpacer = (function(_this) {
        return function($thisSpacer) {
          ...
          if (isCorrect()) {
            stop = true;
            startAnimating(4.5, 'consequences');
            animations.change_states(1);
            stop = false;
